...
const ListforSale = () => {
  ...
  const handleFinish = async () => {
    ...
    // const estimatedGas = await data.estimateGas(accounts[0]);
            ...
            <div className="artwork-traits">
              ...
              <div className="add-traits mt-3 d-flex flex-column">
                <p className="body-medium text-medium-grey">
                  You will not be able to change the price after listing. If
                  you'd like to change the price, you will need to create a new
                  listing.
                </p>
